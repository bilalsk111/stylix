        ...
        <div>
          ...
          {viewMode === 'list' && (
            <p className="text-xs font-medium text-stone-500 line-clamp-3 max-w-2xl leading-relaxed">
              {product.description || "A staple piece curated for the modern wardrobe. Engineered with premium materials to ensure lasting structure and a refined aesthetic."}
            </p>
          )}
        </div>
