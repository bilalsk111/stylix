...
import {
  ...
  ChevronLeft, Trash2, Settings, Store
} from "lucide-react";
          ...
          {isSeller && (
            <div className="space-y-2 md:col-span-2">
              <label className="text-[9px] font-black uppercase tracking-widest text-stone-500 flex items-center gap-1.5">
                <Store size={12} /> Store / Brand Name
              </label>
              <input
                type="text"
                name="storeName"
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-8 lg:p-10 shadow-sm mb-10 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 bg-stone-900 text-white rounded-2xl flex items-center justify-center text-3xl font-black uppercase shadow-lg transform -rotate-3 hover:rotate-0 transition-transform shrink-0">
                {isSeller && currentUser?.storeName 
                  ? currentUser.storeName.charAt(0) 
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 text-stone-500 text-[11px] font-bold uppercase tracking-widest mt-1">
          ...
          activeTab === "settings" ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up">
              ...
              <div onClick={() => setActiveTab("settings")} className="bg-stone-900 border border-stone-800 p-8 rounded-2xl cursor-pointer hover:bg-stone-800 transition-all group shadow-sm">
                ...
                <p className="text-xs text-stone-400 font-medium mb-6">Update contact details, store name, and secure passwords.</p>
